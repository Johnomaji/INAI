...
const members = [
  {
    ...
    role: 'CEO & Co-founder',
    bio: 'Former ML lead at Andela. 2× founder. Building the AI infrastructure layer Africa deserves.',
    color: 'var(--ac)',
    initial: 'AO',
  },
  {
    ...
    role: 'CTO & Co-founder',
    bio: 'Ex-Google Brain engineer. Obsessed with GPU inference at African latency.',
    color: 'var(--blue)',
    initial: 'CO',
  },
  {
    ...
    bio: 'Built payments at Flutterwave. Turns complex AI systems into products people actually love.',
    color: 'var(--purple)',
    initial: 'KM',
  },
  {
    name: 'Amara Diallo',
    role: 'Head of Growth',
    bio: 'Led enterprise sales at Paystack across West Africa. Closing deals at the intersection of AI and ops.',
    color: 'var(--amber)',
    initial: 'AD',
  },
]
